...
<html>
	<head>
		<meta charset="utf-8">
		<title>Eliminar Tipo Pregunta</title>
	...
	<body class="home">
		...
		<div id="wrapper">
			...
			<div id="main">
			  <form name="eliminarPregunta" method="post">
			    <div>
			      ...
			      <div>
			        <table>
			          ...
			          <tr>
			            <td ></td>
			            <td  ><button class="submit" formaction="ToTipoPregunta?x=EliminarTipoPregunta" type="submit" >Eliminar Tipo de Pregunta</button></td>
		              </tr>
		            </table>
		          </div>
		        </div>
