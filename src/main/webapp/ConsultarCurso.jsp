...
<html>
	...
	<body class="home">
		...
		<div id="wrapper">
			...
			<div id="main">
			  <form name="consultarCurso" method="post">
			    <div>
			      ...
			      <div>
			        <table>
			          ...
			          <tr>
			            <td ></td>
			            <td  ><button class="submit" formaction="consultarCurso" type="submit" >Consultar Curso</button></td>
		              </tr>
		              ...
		              <%
						...
						%>
		              <% if(curso!=null&&texto!=null){ %>
		              <tr>
			            <td ><h3>Codigo Curso:</h3></td>
			            <td  ><h3><%= curso %></h3></td>
		              </tr>
		              <tr>
		              ...
		              <tr>
			            <td ></td>
			            <td  ><button class="submit" formaction="ToCurso?x=ConsultarCurso" type="submit" >Salir</button></td>
		              </tr>
		              <% } %>
		            </table>
		          </div>
