...
<html>
	...
	<body class="home">
		...
		<div id="wrapper">
			...
			<div id="main">
			  <form name="consultaTema" method="post">
			    <div>
			      <h2>Consultar Tema</h2>
			      <div>
			        <table>
			          <tr>
			          ...
			          <tr>
			            <td ></td>
			            <td  ><button class="submit" formaction="consultarTema" type="submit" >Consultar Tema</button></td>
		              </tr>
		              
		              <%
		              		String subtema = (String) request.getAttribute("Tema");  		
		             		 String texto= (String) request.getAttribute("texto");
		             		String texto2= (String) request.getAttribute("texto2");
						%>
		              <% if(subtema!=null&&texto!=null){ %>
		              <tr>
			            <td ><h3>Codigo Tema:</h3></td>
			            <td  ><h3><%= subtema %></h3></td>
		              </tr>
		              <tr>
		              ...
		              <tr>
			            <td ></td>
			            <td  ><button class="submit" formaction="ToTema?x=ConsultarTema" type="submit" >Salir</button></td>
		              </tr>
		              <% } %>
		            </table>
		          </div>
