...
public class Subtema {
	...
	public  void registrarSubTema(String codTema, String pDescripcionSubtema)//no ha sido anadiad a la base
	{
	 	getConexion().insertDelete("insert into subtema(codtema,descripcion) values (" +"'"+ codTema +  "','" + pDescripcionSubtema +"'" + ")");
	}
